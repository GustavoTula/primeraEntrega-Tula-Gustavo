...
function provincias(){
    ...
    while(repasarOpciones){
        if(repasarOpciones == 1){
            ...
            let cordoba = alert("Cordoba: Pese a su latitud, el clima de la ciudad de Córdoba, como el de la mayor parte de la provincia, es templado moderado con las cuatro estaciones bien definidas; costo = $35.000")
            let santaCruz = alert("Santa Cruz: la región andina se caracteriza por la presencia de la sección de la cordillera de los Andes denominada Andes Patagónicos, costo = $70.000") 
            let repasarOpcionesS = prompt("Quiere continuar?: \n 1 - Si  \n 2 - No")
            if(repasarOpcionesS == 1){
    ...
    switch (opcionesProvincias){
        case 1:
            alert(nombre +" "+ dni +" "+"lo esperamos con ansias en Mendoza! por un total de: $40.000 ")
            break;    
        case 2:
            alert(nombre +" "+ dni +" "+"lo esperamos con ansias Buenos Aires! por un total de: $50.000")
            break;  
        case 3:
            alert(nombre +" "+ dni +" "+"lo esperamos con ansias Cordoba! por un total de: $35.000")
            break; 
        case 4:
            alert(nombre +" "+ dni +" "+"lo esperamos con ansias Santa Cruz! por un total de: $70.000 ")
            break;
        default:
            ...
            if(releccion == 1){
                ...
                switch(opcionesProvincias){
                    ...
                    case 3:
                        ...
                        break ;
                    case 4:
                        alert(nombre +" "+ dni +" "+"lLo esperamos con ansias Santa Cruz! por un total de: $70.000 ")
                        break;
                    case 5:
                        alert(nombre +" "+ dni +" "+"lLamentamos que ningun destino le haya interesado! hasta la proxima!")
                        break;
                    default:
